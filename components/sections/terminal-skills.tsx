...
export default function TerminalSkills() {
  ...
  const handleCommand = (e) => {
    ...
    const newHistory = [...commandHistory, { type: "command", content: `> ${typedCommand}` }]
    ...
    >
      ...
      <div className="grid md:grid-cols-5">
        ...
        <div className="md:col-span-4 flex flex-col h-[500px] md:h-[600px]">
          ...
          {/* Terminal input */}
          <form onSubmit={handleCommand} className="border-t border-primary/20 p-4 flex items-center">
